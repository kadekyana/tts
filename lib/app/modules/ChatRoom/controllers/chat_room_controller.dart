...
class ChatRoomController extends GetxController {
  ...
  // Tambahkan variabel untuk menentukan mode
  String mode = ''; // 'look_and_say' atau 'look_and_write'
  ...
  // Fungsi untuk menghentikan listening dan mengecek jawaban
  ...
  void updateNextButtonState() {
    if (currentIndex.value < arguments.length - 1) {
      ...
      showNextButton.value =
          false; // Terakhir, mungkin akan menampilkan tombol "Finish"
    }
  }
  ...
  void nextDialog() {
    if (currentIndex.value < arguments.length - 1) {
      ...
      // Aksi jika sudah mencapai akhir dialog
      print("Sudah mencapai akhir dialog");
    }
  }

  void showSpeechNotAvailableDialog() {
    // Logika untuk menampilkan dialog jika Speech Recognition tidak tersedia
    print("Speech recognition tidak tersedia di perangkat ini.");
  }
